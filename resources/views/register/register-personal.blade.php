...
@section('contents')
    <div class="card card-info">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <h4>การลงทะเบียนของผู้ให้กู้ที่เป็นบุคคลธรรมดา</h4>
                </div>
            </div>
            <hr>
            <div class="row">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" placeholder="รายได้ต่อเดือน">
                            </div>
                            <div class="form-group col-lg-4">
                                <label>การศึกษาสูงสุด*</label>
                                <input type="text" class="form-control" placeholder="การศึกษาสูงสุด">
                            </div>
                            <div class="form-group col-lg-4">
                                ...
                                <select class="form-control custom-select">
                                    ...
                                    <option value="retired-with-income">Retired with Income</option>
                                    <option value="retired-without-income">Retired without Income</option>
                                    <option value="un-employed-with-income">Un-employed with Income</option>
                                    <option value="un-employed-without-income">Un-employed without Income</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="ssnFile"
                                           onchange="getImage('#ssnFile', '#uploadSSN', '#ssnPanel')">
                        ...
                        <!-- Address info -->
                        <h5 style="margin-top: 1rem;">ที่อยู่ตามทะเบียนบ้าน</h5>
                        <hr>
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                <label>รูปทะเบียนบ้าน</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="addressFile"
                                           onchange="getImage('#addressFile', '#uploadAddress', '#addressPanel')">
                                    <label class="custom-file-label" for="addressFile">อัปโหลดรูปทะเบียนบ้าน</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-row" style="display: none; margin-bottom: 10px;" id="addressPanel">
                            <div class="col-lg-4">
                                <a type="button" onclick="showImage('address')">
                                    <img id="uploadAddress" class="img-fluid rounded">
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a class="btn btn-danger btn-sm" style="color: white;"
                                   onclick="removeImage('#addressPanel')">
                                    <i class="fas fa-trash"></i>
                                    ลบ
                                </a>
                            </div>
                        ...
                        <!-- Contact info -->
                        <h5 style="margin-top: 1rem;">ข้อมูลผู้ติดต่อ</h5>
                        <hr>
                        <h6>ผู้ติดต่อกรณีฉุกเฉิน</h6>
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                <label>ชื่อ*</label>
                                <input type="text" class="form-control" placeholder="ชื่อ">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="bookBankFile"
                                           onchange="getImage('#bookBankFile', '#uploadedBookBank', '#bookBankPanel')">
                        ...
                        <div class="form-row" style="display: none; margin-bottom: 10px;" id="bookBankPanel">
                            ...
                            <div class="col-lg-4">
                                <a class="btn btn-danger btn-sm" style="color: white;"
                                   onclick="removeImage('#bookBankPanel')">
                                    <i class="fas fa-trash"></i>
                                    ลบ
                                </a>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="condition3">ข้าพเจ้าได้อ่านและทำความเข้าใจ
                                        Privacy Policy, xxx Terms, xxx Terms และยินยอมที่จะ xxx
                                        ตามเงื่อนไขทั้งหมด</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-row justify-content-center">
                            <a href="/register/question" class="btn btn-primary">สมัคร</a>
                        </div>
                    </form>
                </div>
            </div>
