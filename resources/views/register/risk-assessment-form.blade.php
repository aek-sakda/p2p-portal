...
{{--                    <h4>{{ $header }}</h4>--}}
                    @if($type == 'personal')
                        <h4>แบบประเมินความเหมาะสมในการลงทุนสำหรับบุคคลธรรมดา (สำหรับผู้ให้กู้)</h4>
                    @else
                        <h4>แบบประเมินความเหมาะสมในการลงทุนสำหรับนิติบุคคล (สำหรับผู้ให้กู้)</h4>
                    @endif
                </div>
            </div>
            <hr>
...
{{--                        @endforeach--}}
                        ...
                        @if($type == 'personal')
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>2. ปัจจุบันท่านมีภาระทางการเงินและค่าใช้จ่ายประจำ เช่น ค่าผ่อนรถ ค่าใช้จ่ายส่วนตัว และค่าเลี้ยงดูครอบครัว เป็นสัดส่วนเท่าใด</label>
                                    <div class="custom-control custom-radio">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q2-2">ระหว่างร้อยละ 50 ถึงร้อยละ 75 ของรายได้ทั้งหมด</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q2" id="q2-3" value="3">
                                        <p class="custom-control-label" for="q2-3">ระหว่างร้อยละ 25 ถึงร้อยละ 50 ของรายได้ทั้งหมด</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q3-4">มีความมั่นใจว่ามีเงินออมหรือเงินลงทุนเพียงพอสำหรับการใช้ชีวิตหลังเกษียณอายุแล้ว</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label>4. ท่านเคยมีประสบการณ์หรือมีความรู้ในการลงทุนในทรัพย์สินกลุ่มใดต่อไปนี้บ้าง (เลือกได้มากกว่า 1 ข้อ)</label>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <p class="custom-control-label" for="q4-4">หุ้นสามัญ หรือกองทุนรวมหุ้น หรือสินทรัพย์อื่นที่มีความเสี่ยงสูง</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q6-1">เน้นเงินต้นต้องปลอดภัยและได้รับผลตอบแทนสม่ำสมอ แต่ต่ำได้</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q6" id="q6-2" value="2">
                                        <p class="custom-control-label" for="q6-2">เน้นโอกาสได้รับผลตอบแทนที่สม่ำเสมอ แต่อาจเสี่ยงที่จะสูญเสียเงินต้นได้บ้าง</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q6" id="q6-3" value="3">
                                        <p class="custom-control-label" for="q6-3">เน้นโอกาสได้รับผลตอบแทนที่สูงขึ้น แต่อาจเสี่ยงที่จะสูญเสียเงินต้นได้มากขึ้น</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q6" id="q6-4" value="4">
                                        <p class="custom-control-label" for="q6-4">เน้นผลตอบแทนสูงสุดในระยะยาว แต่อาจเสี่ยงที่จะสูญเงินต้นส่วนใหญ่ได้</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label>7. เมื่อพิจารณาผลตอบแทนของกลุ่มการลงทุนที่อาจเกิดขึ้น ท่านเต็มใจที่จะลงทุนในกลุ่มการลงทุนใดมากที่สุด</label>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q7" id="q7-1" value="1">
                                        <p class="custom-control-label" for="q7-1">กลุ่มการลงทุนที่1 มีโอกาสได้รับผลตอบแทน 2.5% โดยไม่ขาดทุนเลย</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q7" id="q7-2" value="2">
                                        <p class="custom-control-label" for="q7-2">กลุ่มการลงทุนที่2 มีโอกาสได้รับผลตอบแทนสูงสุด 7% แต่อาจมีผลขาดทุนได้ถึง 1%</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q7" id="q7-3" value="3">
                                        <p class="custom-control-label" for="q7-3">กลุ่มการลงทุนที่3 มีโอกาสได้รับผลตอบแทนสูงสุด 15% แต่อาจมีผลขาดทุนได้ถึง 5%</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q7" id="q7-4" value="4">
                                        <p class="custom-control-label" for="q7-4">กลุ่มการลงทุนที่4 มีโอกาสได้รับผลตอบแทนสูงสุด 25% แต่อาจมีผลขาดทุนได้ถึง 15%</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label>8. ถ้าท่านเลือกลงทุนในทรัพย์สินที่มีโอกาสได้รับผลตอบแทนมากแต่มีโอกาสขาดทุนสูงด้วยเช่นกัน ท่านจะรู้สึกอย่างไร</label>
                                    <div class="custom-control custom-radio">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q8-4">ไม่กังวลกับโอกาสขาดทุนสูงและหวังกับผลตอบแทนที่อาจจะได้รับสูงขึ้น</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label>9. ท่านจะรู้สึกกังวล/รับไม่ได้เมื่อมูลค่าเงินลงทุนของท่านมีการปรับตัวลดลงในสัดส่วนเท่าใด</label>
                                    <div class="custom-control custom-radio">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>10. หากปีที่แล้วท่านลงทุนไป 100,000 บาท ปีนี้ท่านพบว่ามูลค่าเงินลงทุนลดลงเหลือ 85,000 บาท ท่านจะทำอย่างไร</label>
                                    <div class="custom-control custom-radio">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q10-2">กังวลใจและจะปรับเปลี่ยนการลงทุนบางส่วนไปในทรัพย์สินที่เสี่ยงน้อยลง</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <p class="custom-control-label" for="q10-4">ยังมั่นใจเพราะเข้าใจว่าต้องลงทุนระยะยาวและจะเพิ่มเงินลงทุนในแบบเดิมเพื่อเฉลี่ยต้นทุน</p>
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="form-row">
                                <div class="form-group">
                                    <label>1. ปัจจุบันบริษัท/สถาบัน/นิติบุคคลของท่านดำเนินกิจการมาแล้วกี่ปี </label>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q1" id="q1-1" value="1">
                                        <p class="custom-control-label" for="q1-1">น้อยกว่า 2 ปี</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q1" id="q1-2" value="2">
                                        <p class="custom-control-label" for="q1-2">2-5 ปี</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q1" id="q1-3" value="3">
                                        <p class="custom-control-label" for="q1-3">มากกว่า 5 ปีแต่ไม่เกิน 10 ปี</p>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="q1" id="q1-4" value="4">
                                        <p class="custom-control-label" for="q1-4">มากกว่า 10 ปี</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                        ...
                        <div class="text-center">
                            ...
                            <a href="/register/risk-assessment-result" class="btn btn-primary">ส่งคำตอบ</a>
                        </div>
                    </form>
                </div>
            </div>
